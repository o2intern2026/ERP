...
return [
    ...
    'invoice' => [
        'title' => 'TAX INVOICE',
        // Seller block (audit 2026-09-22 FIN-01 / GAP-04): supplier name + ABN top-left, "How to pay" with the invoice number as the reference.
        'abn' => 'ABN',
        'phone' => 'Phone',
        'email' => 'Email',
        'bill_to' => 'Bill to',
        ...
        'total' => 'Total AUD',
        'less_credit_notes' => 'Less credit notes',
        'paid' => 'Paid',
        ...
        'footer' => 'Amounts in AUD; GST at 10% where applicable. Each line names the order, ASN, container or mark it was raised for; the rate is the one agreed on your rate card at the time of the activity.',
    ],
    ...
    'consignment_note' => [
        ...
        // CHANGE_REQUESTS #135 (audit GAP-05): From / Deliver to on every note, tracking number, instructions, the signing box.
        'from' => 'From',
        'phone' => 'Phone',
        'instructions' => 'Delivery instructions',
        'tracking' => 'Tracking no.',
        'tailgate_flag' => 'TAILGATE REQUIRED',
        'received_title' => 'Received in good order',
        'name' => 'Name',
        'signature' => 'Signature',
        'date' => 'Date',
        'carrier' => 'Carrier',

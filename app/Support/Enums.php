...
final class Enums
{
    ...
    public const EXCEPTION_TYPES = ['discrepancy', 'pick_short', 'delivery_failed', 'manual_transport', 'missing_rate', 'billing_hold', 'integration_failed', 'hold', 'stock_shortage', 'cancel_request'];

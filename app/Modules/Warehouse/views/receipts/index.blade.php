...
@section('content')
    ...
    <form method="get" class="grid">
        ...
        <x-date-field name="date_from" value="{{ $filters['date_from'] ?? '' }}" aria-label="{{ __('warehouse.receipts.date_from') }}" />
        <x-date-field name="date_to" value="{{ $filters['date_to'] ?? '' }}" aria-label="{{ __('warehouse.receipts.date_to') }}" />

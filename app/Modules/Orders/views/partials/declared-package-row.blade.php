...
<tr class="declared-package" data-index="{{ $index }}">
    ...
    <td class="num"><input type="number" min="0.001" step="0.001" required name="{{ $name('weight_kg') }}" value="{{ $package['weight_kg'] ?? '' }}" placeholder="kg" aria-label="{{ __('orders.pickup.weight_kg') }}"></td>

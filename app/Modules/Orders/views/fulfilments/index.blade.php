...
@section('content')
    ...
    <p>{{ $order->client->name }} · {{ __('orders.fields.fulfilment_status') }}: <strong>{!! \App\Support\Ui\StatusBadge::render('orders.statuses.fulfilment.', $order->fulfilment_status) !!}</strong></p>

...
@section('content')
    ...
    <div class="overflow-auto"><table class="dense">
        <thead><tr><th>{{ __('billing.charges.code') }}</th><th>{{ __('billing.rate_cards.pricing_mode') }}</th><th class="num">{{ __('billing.rate_cards.rate') }}</th><th class="num">{{ __('billing.rate_cards.min_charge') }}</th><th>{{ __('billing.rate_cards.pallet_class') }}</th><th>{{ __('billing.rate_cards.band') }}</th><th>{{ __('billing.rate_cards.zone') }} / {{ __('billing.rate_cards.service_level') }}</th><th>{{ __('billing.rate_cards.warehouse') }}</th><th>{{ __('billing.rate_cards.thresholds') }}</th>@if ($card->status === 'draft')<th>{{ __('platform.common.actions') }}</th>@endif</tr></thead>
        <tbody>

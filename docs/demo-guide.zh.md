...
| 客户门户 | /portal | 我的订单、下单、估价、确认运输方案、预报入库 /portal/asns（只读）、上传入库清单 /portal/asns/imports/create（CSV / Excel → 预览 → 确认生成订单，模板 /portal/asns/imports/template，已提交清单 /portal/asns/imports）、我的库存 /portal/stock、我的账单 /portal/invoices、我的报表 /portal/reports |

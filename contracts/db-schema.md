...
| `asns` | id, asn_no (unique), job_id, client_id, warehouse_id, expected_date, inbound_type, status, created_by_type, created_by, unplanned (bool), arrived_at, closed_at, timestamps |
...
| `stock_units` | id, client_id, job_id, asn_line_id, warehouse_id, unit_type, label_code (unique), location_id, qty_on_hand, qty_reserved, qty_inbound, pallet_class, pallet_class_overridden_reason, length_mm, width_mm, height_mm, weight_kg, pallet_source, condition, received_at, timestamps |
| `warehouse_tasks` | id, task_no (unique), task_type, job_id, client_id, warehouse_id, source_type, source_id, order_id, fulfilment_id, asn_id, container_id, priority, assigned_user_id, status, exception_reason, cancel_reason, billable_qty, billable_uom, hours_business, hours_after_hours, started_at, completed_at, completed_by, billable_event_id (→ outbox_events.event_id), timestamps |
